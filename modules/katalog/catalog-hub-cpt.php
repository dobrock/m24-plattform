 ...
 * Intro/SEO-Text, Bilder und Cross-Links. Frontend bleibt /gebrauchtteile/{slug}/
	...
	public static function render( $post ) {
		...
		<div class="m24hb">
			<div class="row">
				...
				<input type="text" id="m24_hub_slug" name="m24_hub_slug" value="<?php echo esc_attr( $slug ); ?>" placeholder="z. B. m3-e30">
				<p class="d">Frontend-URL: <code><?php echo esc_html( home_url( '/gebrauchtteile/' ) ); ?><strong><?php echo esc_html( $slug ?: '{slug}' ); ?></strong>/</code> · leer ⇒ aus Titel. Nach Slug-Änderung Permalinks neu speichern.</p>
			</div>
				...
				<div id="m24-hub-cl">
					...
					foreach ( $rows as $r ) : ?>
						<div class="clrow">
							...
							<input type="text" name="m24_hub_cl_url[]" value="<?php echo esc_attr( $r['url'] ?? '' ); ?>" placeholder="URL (z. B. /gebrauchtteile/m3-e46/)">
							<button type="button" class="button m24-cl-rm">−</button>
						</div>
					<?php endforeach; ?>
				</div>
				<button type="button" class="button" id="m24-hub-cl-add">+ Zeile</button>
				<p class="d">Leere Zeilen werden ignoriert. Interne Pfade (z. B. <code>/gebrauchtteile/m3-e46/</code>) oder volle URLs.</p>
			</div>
		</div>
		<?php
	}
	...
	public static function seed_data() {
		...
		return array(
			array(
				...
				'cross_links' => array(
					array( 'label' => 'passend für BMW M3 E36', 'url' => '/gebrauchtteile/m3-e36/' ),
					array( 'label' => 'passend für BMW M3 E46', 'url' => '/gebrauchtteile/m3-e46/' ),
				),
			),
			array(
				...
				'cross_links' => array(
					array( 'label' => 'passend für BMW M3 E30', 'url' => '/gebrauchtteile/m3-e30/' ),
					array( 'label' => 'passend für BMW M3 E46', 'url' => '/gebrauchtteile/m3-e46/' ),
				),
			),
			array(
				...
				'cross_links' => array(
					array( 'label' => 'passend für BMW M3 E36', 'url' => '/gebrauchtteile/m3-e36/' ),
					array( 'label' => 'passend für BMW M3 E9x', 'url' => '/gebrauchtteile/m3-e9x/' ),
				),
			),
			array(
				...
				'cross_links' => array(
					array( 'label' => 'passend für BMW M3 E46', 'url' => '/gebrauchtteile/m3-e46/' ),
					array( 'label' => 'passend für weitere BMW M-Modelle', 'url' => '/gebrauchtteile/sonstige-bmw-m-modelle/' ),
				),
			),
			array(
