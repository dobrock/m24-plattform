...
class M24_Catalog_Template_Detail {
	...
	private static function render( $id, $status ) {
		...
		.m24det .m24-review-card{box-sizing:border-box;float:right;width:66%;max-width:460px;margin:2px 0 14px 28px;border:1px solid var(--line);border-radius:12px;padding:12px 15px;background:#fbfaf8;box-shadow:0 3px 12px rgba(0,0,0,.05);font-size:14px}
		...
		<div class="m24det" id="m24det-<?php echo (int) $id; ?>">
			...
			<div class="m24-tabs">
				...
				<div class="tabbar">
					...
					<?php endif; ?>
					<?php if ( $has_review ) : ?>
						<button type="button" class="tab m24-rv-tab-btn" data-tab="reviews">Google-Bewertung</button>
					<?php endif; ?>
				</div>
