...
/* Top-Leiste (Menü-<li> neben Kontakt/Impressum): Farbe/Größe vom Menü erben statt hart weiß */
.m24langsw-li{display:flex!important;align-items:center}
.m24langsw--topbar{margin:0;font-size:inherit;line-height:inherit;vertical-align:middle}
.m24langsw--topbar .m24langsw-lnk{color:inherit;opacity:.75}
.m24langsw--topbar .m24langsw-lnk:hover,.m24langsw--topbar .m24langsw-lnk:focus{color:inherit;opacity:1}
.m24langsw--topbar .m24langsw-lnk.is-active{opacity:1;font-weight:700;border-bottom:2px solid #9a6b25}
.m24langsw-tip{display:none!important}
    ...
    public static function strings(): array {
        return array(
            'de' => array(
                // Registrierung
                'reg_h1'        => 'Registrierung',
                'reg_sub'       => 'Für Ihr MOTORSPORT24-Kundenkonto. Wir prüfen Ihre Angaben und schalten Sie frei.',
                'f_firma'       => 'Firma',
                'f_anrede'      => 'Anrede',
                'anrede_herr'   => 'Herr',
                'anrede_frau'   => 'Frau',
                ...
                'login_ok_title'=> 'Login-Link unterwegs',
                'login_ok_text' => 'Wir haben dir eine E-Mail geschickt. Öffne den Link darin, um dich einzuloggen — er ist 15 Minuten gültig.',
                ...
                'mail_verify_body'     => 'Klicke zum Bestätigen deiner Registrierung. Der Link ist 15 Minuten gültig.',
                ...
                'mail_approval_subject'=> 'Dein Zugang ist freigeschaltet – MOTORSPORT24',
                'mail_approval_headline'=> 'Zugang freigeschaltet',
                'mail_approval_body'   => 'Deine Registrierung wurde geprüft und freigeschaltet. Du kannst dich jetzt einloggen.',
                'mail_approval_button' => 'Zum Login',
                'mail_rejection_subject'=> 'Zu deiner Registrierung – MOTORSPORT24',
                'mail_rejection_headline'=> 'Zu deiner Registrierung',
                'mail_rejection_body'  => 'Wir konnten deine Registrierung für ein Kundenkonto aktuell nicht freischalten.',
            ...
            'en' => array(
                'reg_h1'        => 'Registration',
                'reg_sub'       => 'For your MOTORSPORT24 account. We review your details and approve your account.',
                'f_firma'       => 'Company',
                'f_anrede'      => 'Salutation',
                'anrede_herr'   => 'Mr',
                'anrede_frau'   => 'Ms',
                ...
                'login_ok_title'=> 'Login link on the way',
                'login_ok_text' => 'We have sent you an email. Open the link inside to log in — it is valid for 15 minutes.',
                ...
                'mail_verify_body'     => 'Click to confirm your registration. The link is valid for 15 minutes.',
                ...
                'mail_approval_subject'=> 'Your access is approved – MOTORSPORT24',
                'mail_approval_headline'=> 'Access approved',
                'mail_approval_body'   => 'Your registration has been reviewed and approved. You can now log in.',
                'mail_approval_button' => 'Go to login',
                'mail_rejection_subject'=> 'Regarding your registration – MOTORSPORT24',
                'mail_rejection_headline'=> 'Regarding your registration',
                'mail_rejection_body'  => 'We were unable to approve your registration at this time.',
