...
define( 'M24_PLATTFORM_DB_VERSION',  '035' );
...
require_once M24_PLATTFORM_DIR . 'includes/class-m24-user-activity.php'; // Nutzer-Aktivität & Herkunft: _m24_last_login + _m24_signup_source (Tracking)
...
require_once M24_PLATTFORM_DIR . 'includes/class-m24-offer-thread.php';      // Verlauf am Angebot: Spiegel der Desk-Entitaet `thread` (Desk→WP, append-only)
...
require_once M24_PLATTFORM_DIR . 'modules/katalog/catalog-partnums.php'; // v3/C1: Teilenummern-Index (_m24_partnums)
...
add_action( 'plugins_loaded', function() {
    ...
    M24_Catalog_Partnums::init(); // v3/C1: save_post-Reindex + Backfill-Cron
    ...
    M24_Garage_Offer_Bridge::init(); // Garage → Angebot (Operator, manage_options): REST /offers/from-garage
    M24_Offer_Accept::init(); // Angebots-Annahme: Login-Gate + Magic-Link-Rückkehr (REST /offers/request-login)
